...
public class graph extends javax.swing.JPanel implements ActionListener {
	...
	public void inizializza() {
		...
		p3.setBorder(BorderFactory.createCompoundBorder(BorderFactory
				.createTitledBorder("grafo "), BorderFactory.createEmptyBorder(
				1, 1, 1, 1)));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("Function")) {
			...
			for (int j = 0; j < 20; j++) {
				double y2 = RandomUtils.randomInt(300);
				double x2 = j * 2;
			...
			for (int j = 21; j < 200; j++) {
				double y2 = RandomUtils.randomInt(700);
				double x2 = j * 2;
				double wx = 5 - RandomUtils.randomInt(10);
